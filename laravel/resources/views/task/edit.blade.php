...
@section('content')
<div>
    <form action="{{ route('task.update',$task->id) }}" method="POST" style="max-width: 800px; margin: 0 auto;">
        @csrf
        @method('PATCH')
        <div style="margin-bottom: 1.5rem;">
            <label for="title" style="display: block; margin-bottom: 0.5rem; font-weight: 600;">Название задачи</label>
            <input type="text" required title="Заполните заголовок задачи"
                id="title" 
                name="title"
        ...
        <div style="margin-bottom: 1.5rem;">
            ...
            <textarea  type ="text"required title="Заполните описание задачи"
